...
function displayVillages(villages) {
    ...
    if (villages.length === 0) {
        ...
        villages.forEach(village => {
            ...
            let characterImage = firstCharacter ? firstCharacter.images[0] : ''; // Obtener la URL de la imagen
            ...
            card.innerHTML = `
                <div class="card-body">
                    <h5 class="card-title">${village.name}</h5>
                    ${characterImage ? `<img src="${characterImage}" alt="${firstCharacter.name}" class="card-img-top">` : ''}
                </div>
            `;
        ...
        villages.forEach(village => {
            ...
            card.innerHTML = `
                <div class="card-body">
                    <h5 class="card-title">${village.name}</h5>
                    ${characterImage ? `
                        <img src="${characterImage}" alt="${firstCharacter.name}" class="card-img-top" onerror="this.onerror=null; this.src='https://i.ytimg.com/vi/2yZbsRpAjQI/maxresdefault.jpg';">
                    ` : ''}
                </div>
            `;
...
function displayVillages(villages) {
    ...
    if (villages.length === 0) {
        ...
        villages.forEach(village => {
            let firstCharacter = village.characters[0]; // Obtener el primer personaje
            let characterImage = firstCharacter ? firstCharacter.images[0] : ''; // Obtener la URL de la imagen
            console.log('Character Image URL:', characterImage); // Imprimir la URL en la consola
